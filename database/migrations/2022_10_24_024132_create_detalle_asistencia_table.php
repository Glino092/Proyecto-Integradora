...
class CreateDetalleAsistenciaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('detalle_asistencia', function (Blueprint $table) {
            ...
            $table->foreign('id_asistencia')->references('id')->on('asistencia')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('id_grupo_materia')->references('id')->on('grupo_materia')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('id_tipo_asistencia')->references('id')->on('tipo_asistencia')->onDelete('cascade')->onUpdate('cascade');
